...
import { faCircleEnvelope, faEnvelope, faEnvelopeCircleCheck, faEnvelopeSquare, faLocationDot, faPhone } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className={styles.cmProfile}>
            <div className={styles.cm}>
              ...
              <div className={styles.cminfo}>
                ...
                While growing up, one of my dreams has been to build a company that offers trust-based services.
Thus, further down the years, I developed an interest in the property development business. This
interest was primarily due to my family&#39;s acquisition of some landed properties in Ajah, Lagos State,
Nigeria. Indeed, my family was one of those to own land in the then developing area of Lagos State
in the early 1990s.

However, my interest in Nigeria&#39;s property business nose-dived after my family lost the land due to
ownership conflicts. This ugly experience made me sceptical about further involvement in the murky
waters of property business in Nigeria.

Notwithstanding, in the year 2019, I had a renewed realization that only the involvement of
visionary and virtuous entrepreneurs could sanitize the property development industry in Nigeria.
This resolve led to the birth of bjfpropertiesltd. My participation in the industry is to deliver excellent
and trust-based services that can be relied upon by Nigerians in diasporas and foreign nationals.

We currently have clients from Europe and other parts of the world. Our dream is to keep growing
the Client&#39;s base and carve a niche for ourselves in the industry. With our team of dedicated and
accountable professionals, we are your go-to company for property development and management
in Nigeria.

<p className={styles.sndp}>You are welcome to give us a call today!</p>
...
<FontAwesomeIcon  icon={faEnvelope} style={{color: "#5f5c5c"}} width={50}></FontAwesomeIcon>
</div>
<h4 className={styles.iconDes}>
  Email
</h4>
...
<div className={styles.contactC}>
<div className={styles.icon}>
<FontAwesomeIcon  icon={faPhone} style={{color: "#5f5c5c"}} width={50}></FontAwesomeIcon>
</div>
<h4 className={styles.iconDes}>
  Phone
</h4>
...
<div className={styles.contactC}>
<div className={styles.icon}>
<FontAwesomeIcon  icon={faLocationDot} style={{color: "#5f5c5c"}} width={40}></FontAwesomeIcon>
</div>
<h4 className={styles.iconDes}>
  Address
</h4>
<p className={styles.contactO}>2nd floor, 67 Obafemi Awolowo Way, Ikeja Lagos, Nigeria</p>
