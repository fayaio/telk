  ...
  return (
    <>
      ...
      <div className={styles.homeContainer}>
        ...
        <img src="./chairmanpic.svg" alt="" width={300} height={390} priority />
         </div>
         <div className={styles.cmContent}>
                  ...
                  <a className={styles.cmAnchor} href="/about"> Read More</a>
                </div> 
          </div>
        </div>
            ...
            <div className={styles.allTeams}>
              <div className={styles.team}>
                <div className={styles.memeberFrame}>
                  <img className={styles.memeberImg} src="/Rufus.svg" alt="" priority/>
                </div>
              ...
              <div className={styles.team}>
                <div className={styles.memeberFrame}>
                  <img className={styles.memeberImg} src="/Ann.svg" alt="" priority/>
                </div>
                <div className={styles.teamInfo}>
              ...
              <div className={styles.team}>
                <div className={styles.memeberFrame}>
                  <img className={styles.memeberImg} src="/Mark.svg" alt="" priority/>
                </div>
                <div className={styles.teamInfo}>
