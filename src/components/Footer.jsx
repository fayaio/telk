  ...
  return (
    <footer class="p-4 bg-[#29545E] sm:p-6 dark:bg-gray-800 mt-[20px]">
      <div class="flex justify-center">
        <div class="mb-6 md:mb-0 ml-[100px]">
          <a href="#" target="_blank" class="flex items-center  ">
            <img src={logo} class="mr-4 h-10 h-[100px]" alt="Logo" />
          </a>
        </div>
        <div class="grid grid-cols-2 gap-2 sm:gap-6 sm:grid-cols-3 mr-[200px]">
          <div class= "ml-[160px]">
            ...
            <ul>
              <li class="mb-4">
                <a
                  href="#"
                  class="text-white hover:underline dark:text-gray-400"
                >
                  info@bjfpropertycom
                </a>
              </li>
